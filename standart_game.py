...
class StandartGame(game.Game):
    def __init__(self, screen, bg, list_mooving):
        Game.__init__(self, list_mooving, screen)
        self.bg = bg
        self.text_finish = text_blok_object.TextBlockObject(200, 200, Texts.STANDART_GAME_FINISH,\
                                                     MainColors.White, "font.ttf", 70, 50)
        self.text_success_finish = text_blok_object.TextBlockObject(200, 200,Texts.STANDART_GAME_SUCCESS_FINISH,
                                                                    MainColors.White, "font.ttf", 70, 50)
        self.text_greeting = text_blok_object.TextBlockObject(100, 200, Texts.STANDART_GAME_GREETING,
                                                              MainColors.White, "font.ttf", 70, 50)


    def game(self):
        mes_exit_from_game = message.Message(MainColors.Blue, self.text_finish, self.bg, self.screen)
